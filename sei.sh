...
if [ ! $SEI_NODENAME ]; then
	read -p "Enter node name: " SEI_NODENAME
...
echo '================================================='
echo -e "Your node name: \e[1m\e[32m$SEI_NODENAME\e[0m"
echo -e "Your SEI_WALLET name: \e[1m\e[32m$SEI_WALLET\e[0m"
...
# init
seid init $SEI_NODENAME --chain-id $SEI_CHAIN_ID
